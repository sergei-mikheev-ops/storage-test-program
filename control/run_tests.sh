...
# === Функция сбора тестовых параметров ===
get_test_parameters() {
...
run_tests() {
    ...
    # === Создание директории для результатов с правильной структурой ===
...
# === Основной цикл ===
while true; do
    # 1. Сбор параметров для текущего теста
    get_test_parameters
    
    # 2. Запуск тестов
    run_tests
    
    # 3. Спрашиваем, нужно ли тестировать на другом хранилище
    echo -e "\n" + "=".printf '%0.s=' {1..60}
